...
switch ($page) {          
case 'overview':
$title = "Dashboard | Psychic Empress"; 
$insertPage = "main";
...
case 'orders':
$title = "Dashboard - Orders | Psychic Empress"; 
$insertPage = "orders";
...
break;
    ...
    case 'order':
    $title = "Order #".$viewOrder." - Dashboard | Psychic Empress";
    $insertPage = "order";
    ...
    break;
            ...
            case 'profile':
            $title = "Dashboard - Profile | Psychic Empress"; 
            $insertPage = "profile";
